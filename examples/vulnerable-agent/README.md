...
This is a synthetic local review target for FailSafe. It is intentionally small and intentionally constrained so the studio can show a crash-test timeline without touching real files, services, accounts, or external systems.
