...
FailSafe is a defensive crash-test studio for AI agents and MCP toolchains. Keep all work aligned with the tagline: "Crash-test AI agents before production does."

## Safety and Scope

- Keep FailSafe defensive and safety-focused.
- Never generate real exploit deployment instructions against real systems.
- Prefer synthetic examples, mock agents, local fixtures, and dry-run behavior.
...
- Do not implement destructive file, shell, email, network, or database actions in demo mode.
...
- Keep UI polished, readable, responsive, and demo-friendly.
